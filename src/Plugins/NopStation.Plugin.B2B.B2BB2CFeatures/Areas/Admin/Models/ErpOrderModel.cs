...
{
    public record ErpOrderModel : BaseNopEntityModel
    {
        #region Ctor

        public ErpOrderModel()
        {
            CustomValues = new Dictionary<string, object>();
            TaxRates = new List<TaxRate>();
            GiftCards = new List<OrderModel.GiftCard>();
            Items = new List<OrderItemModel>();
            ErpOrderItems = new List<ErpOrderItemAdditionalDataModel>();
        ...
        //Erp
        public IList<ErpOrderItemAdditionalDataModel> ErpOrderItems { get; set; }
        ...
        //gift cards
        public IList<OrderModel.GiftCard> GiftCards { get; set; }
