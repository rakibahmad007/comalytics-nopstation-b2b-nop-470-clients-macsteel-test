...
public record ErpAccountModel : BaseNopEntityModel
{
    ...
    [NopResourceDisplayName("Plugin.Misc.NopStation.ERPIntegrationCore.ErpAccount.Field.SpecialIncludes")]
    public string SpecialIncludes { get; set; }

    [NopResourceDisplayName("Plugin.Misc.NopStation.ERPIntegrationCore.ErpAccount.Field.SpecialExcludes")]
    ...
    [NopResourceDisplayName("Plugin.Misc.NopStation.ERPIntegrationCore.ErpAccount.Fields.PaymentTermsCode")]
    public string PaymentTermsCode { get; set; }

    [NopResourceDisplayName("Plugin.Misc.NopStation.ERPIntegrationCore.ErpAccount.Fields.PaymentTermsDescription")]
