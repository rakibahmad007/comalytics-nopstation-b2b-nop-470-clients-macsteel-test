FiltersManager = function () {
  ...
  function (m, P, x) {
    ...
    m.fn.extend({
      ...
      x.waitForAjaxRequest || "#/noFilterApplied" !== n && (e && t && k() && m.address.history(!0), this.isProductRefreshTriggeredByScroll = a || !1, null == n ? n = "" : i = !0, this.setSpecificationFilterSelection(e, t), l = this.getSpecificationFiltersModel(), p = this.getAttributeFiltersModel(), u = this.getManufacturerFiltersModel(), h = this.getVendorFiltersModel(), v = this.getOnSaleFiltersModel(), f = this.getPriceRangeFilterModel(), S = this.getInStockFiltersModel(), null == s && (s = null), a = m(".sortOptionsDropDown").val() || 0, e = b(), g = m(".productsPageSizeDropDown").val() || 0, null == (t = P.getUrlVar("pageNumber")) || null != s || null != r && !1 !== r || (s = t), null == i && (i = !1), o && (s = o), v = {
      ...
      }, this.isProductRefreshTriggeredByScroll || this.showAjaxLoading(), S = (F = this).getFilteredProductsUrl, x.waitForAjaxRequest = !0, m.ajax({
        cache: !1,
        type: "POST",
        data: m.toJSON(v),
        ...
        if ("" !== n && (F.changeViewModeOrderByAndPageSize(e), F.setPriceRangeValues(e)), F.refreshProducts(e, F.isProductRefreshTriggeredByScroll, c, s)) {
          F.refreshFilters(e), c || F.refreshProductsPager(e), F.refreshClearButtons(), "NO HASH QUERY" !== n && (F.expandFilterPanelsWithSelectedOptions(), "" !== (t = m(e).filter("#urlHashQuery").val().toString()) ? (F.isProductRefreshTriggeredByScroll && (t = t.slice(0, t.indexOf("&pageNumber"))), m.address.value(t)) : c || m.address.value("noFilterApplied")), F.hideAjaxLoading(), x.waitForAjaxRequest = !1;
        ...
        F.hideAjaxLoading(), alert("Loading the page failed."), x.waitForAjaxRequest = !1
      }).always(function () {
      ...
      if (null != m(e).filter(o).html()) {
        ...
        l = !0
      } else this.hideAjaxLoading(), 0 < m("#nopAjaxFiltersNoProductsDialog").length || a.prepend(m(e).filter("#nopAjaxFiltersNoProductsDialog")), this.showNoProductsModalDialog(), l = !1;
      return l
    ...
    }, x.prototype.showAjaxLoading = function () {
      displayAjaxLoading(true)
    }, x.prototype.hideAjaxLoading = function () {
